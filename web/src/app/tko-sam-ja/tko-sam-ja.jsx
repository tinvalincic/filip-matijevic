    ...
    <div className="container">
      <div className={styles.content}>
        ...
        <div>
          ...
          <p>
            Filip Matijević - powerlifting i osobni trener, vlasnik teretane,
            predsjednik powerlifting kluba Gumeni medvjedići i Zagrebačkog
            powerlifting saveza.
          </p>
          <p>
          ...
          <p>
            ...
            karijeru. U idućih 7 godina kroz svoje usluge pomogao sam{" "}
            <strong>više od 40 powerlifera svih razina</strong>, od početnika
            koji su tek ušli u teretanu do državnih rekordera i natjecatelja na
            svjetskoj razini da postave <strong>osobne rekorde</strong> i
            ostvare svoj <strong>potpuni potencijal</strong>.
          </p>
        </div>
      </div>
    </div>
